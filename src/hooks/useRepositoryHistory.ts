...
type UseRepositoryHistoryOptions = Omit<UseQueryOptions<RepositoryResponse[], Error, DocumentItem[]>, 'queryKey' | 'queryFn' | 'select'>;

interface UseRepositoryChatHistoryOptions extends Omit<UseQueryOptions<RepositoryChatHistoryResponse[], Error, ChatMessageType[]>, 'queryKey' | 'queryFn' | 'select'> {
