...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Encontre decisões judiciais relevantes para seu caso com nossa poderosa ferramenta de busca.',
      icon: <Scale size={24} />,
    },
    {
  ...
  return (
    <div className={styles.container}>
      <main className={styles.mainContent}>
        ...
        {/* Seção Features */}
        {filteredFeatures.length === 0 && <p className={styles.noResults}>Nenhum recurso encontrado.</p>}
