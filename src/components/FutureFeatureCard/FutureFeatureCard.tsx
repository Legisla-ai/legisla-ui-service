...
export function FutureFeatureCard({ title, description, icon }: Readonly<FeatureCardProps>) {
  return (
    <div className="relative p-6 transition-all duration-300 ease-in-out flex flex-col gap-4 h-full backdrop-blur-10 shadow-legisla-sm opacity-85 hover:-translate-y-px hover:shadow-legisla-md hover:opacity-100"
         style={{ 
      ...
      <div className="text-xl font-semibold text-gray-900 flex items-center gap-2">
        <div className="text-gray-400 text-3xl p-3 transition-all duration-300 ease-in-out hover:scale-105 hover:text-gray-500"
             style={{ 
